  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-black text-gray-900 md:text-3xl">Budgetplanner</h1>
      ...
      <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-gray-100">
        ...
        <div className="flex gap-3 sm:max-w-sm">
          ...
          <button
            ...
            className="rounded-lg bg-indigo-600 px-5 py-2 text-sm font-semibold text-white hover:bg-indigo-700 disabled:opacity-50 shrink-0"
          >
            Bereken →
          </button>
        </div>
      ...
      {bedragen && (
        <>
                    ...
                    <div className="mb-1 flex items-center justify-between gap-2">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div className="relative">
                          ...
                          <input
                            type="number"
                            className="w-20 rounded-lg border border-gray-200 py-1 pl-6 pr-2 text-right text-sm focus:border-indigo-500 focus:outline-none md:w-24"
                            value={bedrag}
          ...
          <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-gray-100">
            ...
            <div className="mt-4 grid grid-cols-2 gap-x-3 gap-y-2 md:flex md:flex-wrap md:gap-3">
              {CATEGORIEEN.map(cat => (
          ...
          <div className="rounded-xl bg-indigo-50 px-3 py-3 text-sm text-indigo-800 md:px-5 md:py-4">
            <p className="font-semibold">De 50/30/20-regel als richtlijn:</p>
            <ul className="mt-2 space-y-1 text-xs text-indigo-700 md:text-sm">
