...
Op basis van recente salarisdata voor ${data.functie || "mijn functie"} in de ${data.sector || "sector"} — mede via bronnen als SalarisRadar.nl — ligt het marktgemiddelde voor iemand met ${ervaringLabel} ervaring tussen de ${formattedHuidig} en ${formattedGevraagd} bruto per jaar.
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-2xl bg-orange-50 p-5 ring-1 ring-orange-100 text-sm text-orange-900">
              ...
              <p>Controleer eerst je marktwaarde via onze{" "}
                <Link href="/checken" className="underline font-semibold">salarisradar</Link>.
